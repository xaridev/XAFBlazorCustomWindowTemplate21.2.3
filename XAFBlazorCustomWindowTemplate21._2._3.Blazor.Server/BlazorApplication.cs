...
using XAFBlazorCustomWindowTemplate21._2._3.Blazor.Server.Templates;

namespace XAFBlazorCustomWindowTemplate21._2._3.Blazor.Server {
    public partial class XAFBlazorCustomWindowTemplate2123BlazorApplication : BlazorApplication {
        public XAFBlazorCustomWindowTemplate2123BlazorApplication() {
            InitializeComponent();
        }
        protected override IFrameTemplate CreateDefaultTemplate(TemplateContext context)
        {
            ...
            {
                return new CustomWindowTemplate() { AboutInfoString = AboutInfo.Instance.GetAboutInfoString(this) };
            }
        ...
        private void XAFBlazorCustomWindowTemplate2123BlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
